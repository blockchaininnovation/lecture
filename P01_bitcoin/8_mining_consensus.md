...
「署名ハッシュ」とは，署名対象のメッセージのハッシュ値のことかなと思います．
たぶん，署名対象のMSGを抜き出すときに，署名そのものは除外しないとだめ，でという話をしたいのかなと思います．
以下の説明だと，ScriptSig部という署名部分を書き換えて保管しているように読めます．
署名の検証プロセスの一部かな，とも推察しますが文章全体の修正をお願いします．
