...
ブロックチェーンの文脈におけるスケーラビリティ問題とは、**分散的な合意形成の処理がトランザクションの増加に追いつかなくなる問題**を意味する。これはBitcoinと共通する課題である
...
## The Merge
2022年に行われたEthereumの大規模アップデート "The Merge" は、まさにこのスケーラビリティ問題への対処が主目的だった (EIP2982, EIP3675などで議論された)
