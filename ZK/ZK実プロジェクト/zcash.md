...
<!-- 
Txに対してJoinSplitは1個．
Inputの送金額から，Outputの送金額の和が一致していることをここで証明しているはず．

vpub_oldとvpub_newが一致していることで示しているはず．

多分以下のZKプルーフを生成しているんだろう．
・プライベートインプット（一部パブリック？）
　・Tx中の全インプット，アウトプットのNote
　・同じく全インプット，アウトプットのNoteのプルーフ
　・vpub_old, vpub_new
・証明したいこと
　・vpub_old，vpub_newが入出力Noteと矛盾がないこと
